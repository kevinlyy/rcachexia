...
library(tableone)
# Overall
tableOne <- CreateTableOne(vars = colnames(dataset), data = dataset)
table1 <- print(tableOne,nonnormal = colnames(dataset),contDigits=1)
write.csv(table1, file = 'baseline.csv',fileEncoding = 'GB2312')
